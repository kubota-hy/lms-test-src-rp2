...
public class Case07 {
	...
	void test03() {
		...
		WebElement button = webDriver.findElement(
			    By.xpath("//td[span[text()='未提出']]/following-sibling::td//input[@value='詳細']")
			);
	...
	void test05() {
		...
		WebElement alreadySubmitBtn = webDriver.findElement(
				By.cssSelector("input[type='submit'][value='提出済み日報【デモ】を確認する']"));
		
		assertEquals("提出済み日報【デモ】を確認する",alreadySubmitBtn.getAttribute("value"));
